...
Verification is delegated to ``py_webauthn`` 3.0.0 rather than hand-rolled.
...
try:
    ...
    _logger.warning(
        ...
        "install it with: pip install webauthn==3.0.0"
    )
    ...
    def verify_and_store_registration(self, credential_payload, device_label):
        ...
        try:
            verified = verify_registration_response(
                ...
                # The device must check a biometric or PIN. Presence alone
        ...
        transports = (credential_payload or {}).get("transports") or []
